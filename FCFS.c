...
// return sum of all process burst time
int total_burst() {
...
// display FCFS result in outfile
void fcfs(char* out_filename) {
    sort_fcfs();
    int current_time = 0;
    ...
    while (current_node != NULL) {
        ...
        while (current_time < current_process->end_time) {
            // when another process arrives, print
